         ...
         <v-layout row wrap  justify-center>
            <v-flex text-center xs11 sm11 md11 lg11 >
             ...
             <v-flex text-start xs11 sm11 md11 lg11 >
                <p style=" line-height: 1.8;  text-align: start;" v-html="eventItem.description" class="  black--text font-weight-light mr-2  mt-2">{{eventItem.description}} </p>
            </v-flex>
        </v-layout>
